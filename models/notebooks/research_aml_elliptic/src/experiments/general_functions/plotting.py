...
from experiments.general_functions.elliptic_data_preprocessing import (
...
def plot_performance_per_timestep(
    model_metric_dict,
    ...
    ax2.bar(
        timesteps,
        illicit_per_timestep["occurences"],
        color=barcolor,
        alpha=baralpha,
        label="\# illicit",
    )
    ...
    if savefig_path == None:
        ...
        plt.savefig(
            os.path.join(ROOT_DIR, savefig_path), bbox_inches="tight", pad_inches=0
        )
