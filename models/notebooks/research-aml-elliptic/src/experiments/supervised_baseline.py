...
plot_performance_per_timestep(model_metric_dict=model_f1_ts_dict, last_train_time_step=last_train_time_step,
                              ...
                              savefig_path=os.path.join(ROOT_DIR, 'research-aml-elliptic/output/figure_2_supervised_illicit_f1_per_timestep.png'))
...
with open(os.path.join(ROOT_DIR, 'research-aml-elliptic/output/supervised_avg_f1_per_model_over_5_runs.csv'), 'w', newline="") as csv_file:
    writer = csv.writer(csv_file)
    for key, value in model_avg_f1_dict.items():
       writer.writerow([key, value])
save_as_pkl(model_avg_f1_dict, 'research-aml-elliptic/output/supervised_avg_f1_per_model_over_5_runs.csv')
