...
On the following sections, we will delve into the various forms of market manipulation a medium of exchahge can be target of. Specially \emph{Spoofing}
and \emph{Layering} on Bitcoin market.

\input{tex/1_introduction/1_3_market_manipulation/1_3_1_crypto_market_manipulation.tex}
\input{tex/1_introduction/1_3_market_manipulation/1_3_2_what_are_spoofing_and_layering.tex}
\input{tex/1_introduction/1_3_market_manipulation/1_3_3_spoofing_layering_and_high_frequency_trading.tex}
\input{tex/1_introduction/1_3_market_manipulation/1_3_4_spoofing_and_layering_on_bitcoin_trading.tex}