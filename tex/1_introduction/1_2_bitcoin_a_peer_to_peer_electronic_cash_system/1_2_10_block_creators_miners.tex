\subsection{Block Creators: Miners}
...
%% figure 1.13
\figuraBib{img/chapter-1/1_2_10_block_creators_miners/13_block-reward.png}{Block reward}{3blue1brown_block_reward}{reward}
{width=.45\textwidth}%
...
In the consensus algorithm used by Bitcoin and other cryptocurrencies, a mechanism known as "longest chain rule" is employed to resolve
