...
%% figure 1.5
\figuraBib{img/chapter-2/2_2_5_removing_cash/5_invalid.png}{In this new system, we don't allow people to spend more than they have.}{3blue1brown_invalid}{invalid}{width=.85\textwidth}%
...
%% figure 1.6
\figuraBib{img/chapter-2/2_2_5_removing_cash/6_overdrawn.png}
