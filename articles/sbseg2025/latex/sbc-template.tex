...
(when \hl{FS} is tested on imbalanced data). However, these scores still do not reach the F1-Macro of 0.908 achieved by SMOTE
...
\begin{figure}[!tph]
  ...
  \hfill
  \caption{Experiment 3, Technique B: SMOTE With Feature Selection, Increasing Value of k Full Test Dataset, Energy
  Distribution Of Licit and Illicit Transactions.}
\end{figure}
